TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "IN GAME",
		TSPassword = "292497", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "everestrp.ts3brasil.com.br", -- TeamSpeak server address to be displayed on blocking screen
